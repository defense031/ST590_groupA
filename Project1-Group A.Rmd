...
```
## create a scatter plot (not finished yet, I want type1 to be the color but I'm stuck on the factors)
```{r}
ggplot(Pokedf, aes(x = (as.numeric(gsub("kg","",Pokedf[,7]))), y = (as.numeric(gsub("m","",Pokedf[,6]))))) + geom_point()
```
