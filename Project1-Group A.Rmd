...
## Description of Dataset and where it was found.
This dataset comes from a github library of various JSON formatted files. It is based on data for the game Pokemon Go, and contains information about the original 151 Pokemon.
...
## create a custom function & Contingency table
```{r}
...
## Numeric Summary: summary of Average Spawns
```{r}
avgSpawnSummary = c()
...
##Numeric summary: Find mean of spawn chance by type
```{r}
...
## Create a scatter plot use height as response and weight as variable, colored by the primary type.
```{r}
