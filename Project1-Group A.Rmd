...
g2+geom_bar(aes(fill = as.factor(location_categories)))+coord_flip() + labs(x = "Interest Categories", y = "Count", title = "Interest Categories by Location") + scale_fill_discrete(name = "Location")

g3<-ggplot(distinct_summary_locations_interests, aes(x=location_categories, y=efficien_impressions))
g3+geom_boxplot() + labs(x = "Location Categories", y = "Impressions", title = "Impressions by Location")
